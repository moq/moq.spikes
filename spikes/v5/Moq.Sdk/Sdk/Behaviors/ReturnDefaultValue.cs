...
{
	/// <summary>
	/// Behavior that always sets the return value of an 
	/// invocation to the default value for the method 
	/// return type (zero for value types, null for reference
	/// types).
	/// </summary>
	public class ReturnDefaultValue : IAspect
	{
        /// <summary>
